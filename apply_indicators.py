...
def detect_candlestick_patterns(df):
    ...
    """
    def classify_candle(open_, high, low, close, i):
        ...
        elif i > 0 and close > df.iloc[i-1]['open'] and open_ < df.iloc[i-1]['close']:
            return 'bullish_engulfing'
        elif i > 0 and open_ > df.iloc[i-1]['close'] and close < df.iloc[i-1]['open']:
